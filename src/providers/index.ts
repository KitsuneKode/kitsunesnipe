...
export const PLAYWRIGHT_PROVIDERS: readonly PlaywrightProvider[] = PROVIDER_LIST
...
export function buildUrl(
  ...
  return type === "movie"
    ...
    : provider.seriesUrl(tmdbId, season, episode);
}
...
export function buildUrlById(
  ...
  if (p.kind !== "playwright") throw new Error(`Provider "${providerId}" is not a Playwright provider — use resolveStream instead.`);
