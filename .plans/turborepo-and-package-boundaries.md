...
Phase 4E resolver orchestration:

- add a provider-agnostic `resolveWithFallback` orchestrator to `@kunai/core`
- keep concrete provider implementations in `apps/cli`
