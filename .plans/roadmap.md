...
- Phase 4A provider-core foundation is underway with `@kunai/core` owning the first provider manifest and adapter seam.
...
| Turborepo and package boundaries | Phase 4A     | [.plans/turborepo-and-package-boundaries.md](.plans/turborepo-and-package-boundaries.md)             |
