...
(async () => {
  ...
  console.log(
    "Navigating to https://www.rivestream.app/embed/agg?type=tv&id=1396&season=1&episode=1 ...",
  );
  try {
    await page.goto("https://www.rivestream.app/embed/agg?type=tv&id=1396&season=1&episode=1", {
