...
function generateSecretKey(e: string | number, cArray: string[] = []) {
...
console.log("533535 ->", generateSecretKey("533535", cArray), "(Expected: NTU2ZjdhYTc=)");
console.log("1396 ->", generateSecretKey("1396", cArray), "(Expected: Nzg3ZmU5YTI=)");
console.log("278 ->", generateSecretKey("278", cArray), "(Expected: LTJhMzZhYTFi)");
