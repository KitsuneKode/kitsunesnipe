...
async function main() {
    console.log("=========================================");
    console.log(" HDTODAY / VIDKING HEADLESS SCRAPER");
    console.log(" (0 RAM, Multi-Provider, Auto-Highest Quality)");
    console.log("=========================================\n");
    ...
    if (streamData.subtitles && streamData.subtitles.length > 0) {
        const enSub = streamData.subtitles.find((s: any) => s.lang === "eng" && !s.language.includes("SDH"));
        if (enSub) {
