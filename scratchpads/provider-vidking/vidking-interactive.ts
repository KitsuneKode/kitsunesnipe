...
(async () => {
  ...
  await context.addInitScript(() => {
    document.addEventListener(
      ...
      (event) => {
        ...
        const clickable =
          target.closest(
            "button, a, [role='button'], .btn, .tab, [data-id], [data-value], [data-server], li, span, div",
          ) ?? target;
  ...
  console.log(
    "[+] Now waiting for you to interact. Once you click anything, future logs will go to scratchpads/log-interaction-vidking.log",
  );
