...
- **Header/referrer/user-agent requirements:** Specific Referer and Agent required by the API.
...
- **Language matching rules:** Appends '-sub' or '-dub' to GraphQL queries.
...
- **Tests/fixtures needed before claiming subtitle support works:** Test GraphQL query for sub/dub.
